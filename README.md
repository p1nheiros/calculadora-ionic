<div align="center">
 ...
 > Calculadora simples feita em TypeScript, Angular e Ionic.

  <a href="https://github.com/p1nheiros/calculadora-ionic"><strong>➥ Visualizar Projeto</strong></a>
...
```bash
sudo git clone https://github.com/p1nheiros/calculadora-ionic.git
```

Windows:

```bash
git clone https://github.com/p1nheiros/calculadora-ionic.git
```
