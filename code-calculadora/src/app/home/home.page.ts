...
export class HomePage {
  ...
  continuarOperacao() {
    // Esta função é chamada quando o usuário quer continuar com a operação anterior
  ...
  // Método para resetar variáveis após obter um resultado
  resetarCalculo() {
    this.segundo_elemento = "";
    this.operador = ""; // Removido o reset do operador
